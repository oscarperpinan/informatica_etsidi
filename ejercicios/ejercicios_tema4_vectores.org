...
int main()
{
  int p, // Numero a comprobar
    i, // Indice de bucles
    ind_P
    ind_primo = 2,       // Indice del vector primos, que indica la primera posicion libre
    primos[N] = {2, 3};  // Vector de primos, inicializo los dos primeros, y el resto quedan a 0
