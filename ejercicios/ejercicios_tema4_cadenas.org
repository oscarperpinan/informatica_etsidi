...
"Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cras euismod\
 ...
 facilisis mi nisi, vel pulvinar odio auctor posuere.";
  ...
  for (i = 0; i < 5; i++) // Bucle for para recorrer vector de vocales
    {
      j = 0; // Bucle while para recorrer frase
      while (frase[j] != '\0') 
	{
	  if (frase[j] == vocales[i]) // Ha habido una coincidencia
	    nLetra[i]++; // Incremento el contador de apariciones 
	  j++; // Avanzo en la frase
	}
    }
