...
Realice un programa que solicite tres números enteros e imprima el mayor
de ellos.
...
int main()
{
  ...
  {
		printf("ERROR al introducir lso números \n");	
	}
  else
  {
  	if(a<b)
...
int main()
{
  ...
  scanf("%c", &j2);
 	...
 	// Uso al jugador 1 como referencia y, dentro de cada caso, hago las comparaciones necesarias
 	switch(j1)
 	{
