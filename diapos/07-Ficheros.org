...
- Devuelve el número de argumentos que han sido leídos y asignados o =EOF=[fn:1] si se detecta el final del fichero.
...
[fn:1]=EOF= (/End Of File/) es la marca de final de fichero.
