...
\section{Vectores}
\label{sec:org6cace3d}
\begin{frame}[label={sec:org1cbe749},fragile]{Vectores en C}
...
\begin{frame}[label={sec:org3d23303},fragile]{Ejemplos}
 \lstset{language=C,label= ,caption= ,captionpos=b,numbers=none}
\begin{lstlisting}
...
\begin{frame}[label={sec:org8364480},fragile]{Elementos de un vector}
 \begin{itemize}
...
\begin{frame}[label={sec:org38d9080},fragile]{Acceso a datos de un vector}
 \lstset{language=C,label= ,caption= ,captionpos=b,numbers=none}
\begin{lstlisting}
#include <stdio.h>
...
\begin{frame}[label={sec:org4b84739},fragile]{Acceso a datos de un vector}
 \lstset{language=C,label= ,caption= ,captionpos=b,numbers=none}
\begin{lstlisting}
#include <stdio.h>
...
\section{Matrices}
\label{sec:org74c843f}
\begin{frame}[label={sec:org5cedc79},fragile]{Matrices}
 \begin{block}{}
...
\begin{frame}[label={sec:org49f474b},fragile,plain]{Elementos de una matriz}
...
\begin{frame}[label={sec:orga82dd16},fragile]{Inicialización de una matriz}
...
\begin{frame}[label={sec:org22f84a9},fragile]{Inicialización de una matriz}
 Los elementos de una matriz pueden iniciarse en el momento de la declaración.
\lstset{language=C,label= ,caption= ,captionpos=b,numbers=none}
\begin{lstlisting}
#include <stdio.h>
...
\begin{frame}[label={sec:orga6d9e74},fragile,plain]{Operaciones con matrices: suma}
 \lstset{language=C,label= ,caption= ,captionpos=b,numbers=none}
\begin{lstlisting}
#include <stdio.h>
int main() {
...
\begin{frame}[label={sec:orgfd76c08},fragile]{Funciones con matrices}
 \begin{itemize}
...
\begin{frame}[label={sec:orgc3a2336},fragile,plain]{Ejemplo de función con matrices}
 \lstset{language=C,label= ,caption= ,captionpos=b,numbers=none}
\begin{lstlisting}
#include <stdio.h>
...
\begin{frame}[label={sec:orgc09792c},fragile,plain]{Ejemplo de función con matrices (2)}
 \lstset{language=C,label= ,caption= ,captionpos=b,numbers=none}
\begin{lstlisting}
#include <stdio.h>
...
\section{Estructuras}
\label{sec:orgec97b14}
\begin{frame}[label={sec:org44c3686},fragile]{Estructuras en C}
...
\begin{frame}[label={sec:org185610c},fragile]{Estructuras con \texttt{typedef struct}}
...
\begin{frame}[label={sec:org0b6c067},fragile]{Ejemplo con \texttt{struct}}
 \lstset{language=C,label= ,caption= ,captionpos=b,numbers=none}
\begin{lstlisting}
struct contacto
{
...
\begin{frame}[label={sec:orgf893c08},fragile]{Ejemplo con \texttt{typedef struct}}
 \lstset{language=C,label= ,caption= ,captionpos=b,numbers=none}
\begin{lstlisting}
typedef struct 
{
...
\begin{frame}[label={sec:org160b2e4},fragile]{Inicialización de valores en estructuras}
...
\begin{frame}[label={sec:org76e55b5},fragile]{Inicialización de valores en estructuras}
...
\begin{frame}[label={sec:org92e54c9},fragile]{Asignación de valores en estructuras}
 \lstset{language=C,label= ,caption= ,captionpos=b,numbers=none}
\begin{lstlisting}
typedef struct {
  int day;
...
\begin{frame}[label={sec:org85fe72b},fragile]{Asignación de cadenas en estructuras}
 \lstset{language=C,label= ,caption= ,captionpos=b,numbers=none}
\begin{lstlisting}
#include <stdio.h>
#include <string.h>
...
\begin{frame}[label={sec:orgda3c575},fragile]{Acceso a componentes de una estructura}
 \lstset{language=C,label= ,caption= ,captionpos=b,numbers=none}
\begin{lstlisting}
#include <stdio.h>
...
\begin{frame}[label={sec:org38315a3},fragile]{Estructuras dentro de estructuras}
...
\begin{frame}[label={sec:org8ca18cb},fragile]{Estructuras dentro de estructuras}
 \lstset{language=C,label= ,caption= ,captionpos=b,numbers=none}
\begin{lstlisting}
...
\begin{frame}[label={sec:orgbd439b0},fragile,plain]{Vector de estructuras}
...
\label{sec:org63e5ae5}
\begin{frame}[label={sec:org2b1f69c},fragile]{Enumeraciones en C}
 \begin{block}{Definición}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org0a56141},fragile]{Ejemplo (1)}
 \lstset{language=C,label= ,caption= ,captionpos=b,numbers=none}
\begin{lstlisting}
#include <stdio.h>
enum dia{ //valores enteros: 0 al 6
...
\begin{frame}[label={sec:org11972b2},fragile]{Ejemplo (2)}
 \lstset{language=C,label= ,caption= ,captionpos=b,numbers=none}
\begin{lstlisting}
#include <stdio.h>
