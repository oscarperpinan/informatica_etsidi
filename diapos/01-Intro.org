...
#+BEGIN_EXPORT latex
\href{https://www.youtube.com/watch?v=nKIu9yen5nc}{\includegraphics[height=0.9\textheight]{figs/steve-jobs-quote.jpg}}
#+END_EXPORT
...
#+BEGIN_EXPORT latex
\href{https://youtu.be/DKGZlaPlVLY}{\includegraphics[height=0.9\textheight]{figs/HowComputersWork.png}}
#+END_EXPORT
